...
public class quiz extends JFrame  {
    ...
    ButtonGroup groupoptions;
     quiz(){
         setBounds(0,0,1440,675);
         getContentPane().setBackground(Color.white);
         setLayout(null);

         ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/quiz.jpg"));
         JLabel image = new JLabel(i1);
         image.setBounds(0,0,1440,338);
         add(image);
         ...
         next.setBounds(950,400,200,40);
         next.setFont(new Font("Tahoma",Font.PLAIN,22));
         next.setBackground(new Color(30,144,255));
         next.setForeground(Color.white);
         add(next);

         JButton lifeline = new JButton("50-50 (LIFE-LINE)");
         lifeline.setBounds(950,460,200,40);
         ...
         submit.setBounds(950,520,200,40);
     ...
     public void paint(Graphics g){
         ...
         if(ans_given == 1){
             ...
             timer =15;
//             if (groupoptions.getSelect()==null){
//                 useranswers[0][0]="";
//             }
//             else {
//
